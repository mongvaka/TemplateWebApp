...
import { BankItemCustomComponent } from './bank-item-custom.component';
@Component({
...
export class BankItemComponent
  extends BaseItemComponent<BankItemModel>
  implements BaseItemInterface
{
  ...
  bankCategoryOptions: SelectItems[] = [];
  constructor(
    private service: BankService,
    private currentActivatedRoute: ActivatedRoute,
    public custom: BankItemCustomComponent
  ) {
    super();
 ...
 // tslint:disable-next-line: use-lifecycle-interface
  ...
  onEnumLoader(): void {
    this.baseDropdown.getBankCategoreDropDown(this.bankCategoryOptions);
  }
  getById(): Observable<BankItemModel> {
    return this.service.getBankTableById(this.id);
  }
  ...
  onSubmit(isColsing: boolean): void {
    if (this.isUpdateMode) {
      super.onUpdate(this.service.editBankTable(this.model), isColsing);
    } else {
      super.onCreate(this.service.createBankTable(this.model), isColsing);
    }
  }
