...
export class CustButtonComponent extends CustBaseComponent implements OnInit {
  ...
  @Input() set CustConfig(param: ButtonConfigModel) {
    this.bindingInputId = isNullOrUndefined(this.bindingInputId)
      ? Uuid.newUuid()
      : this.bindingInputId;
  }

  @Output() CustClick = new EventEmitter<any>();
